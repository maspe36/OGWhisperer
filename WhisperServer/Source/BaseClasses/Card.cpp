...
/* Wrapper function to damage all creatures in target vector for _Damage amount and then
create Action object and check the next layer of effects.  */
void Card::Damage(vector<Creature*> Targets, Player* Owner)
{
...
/* Wrapper function to heal all creatures in target vector for _Heal amount and then
create Action object and check the next layer of effects.  */
void Card::Heal(vector<Creature*> Targets, Player* Owner)
{
	vector<Card*> tmpCardTargets(Targets.begin(), Targets.end());
...
/* Wrapper function to buff all creatures in target vector for _AttackBuff and _DefenseBuff amounts and then
create Action object and check the next layer of effects.  */
void Card::CreatureBuff(vector<Creature*> Targets, Player * Owner)
{
	vector<Card*> tmpCardTargets(Targets.begin(), Targets.end());
...
void Card::CreatureBuffNoTrigger(vector<Creature*> Targets, Player * Owner)
{
	vector<Card*> tmpCardTargets(Targets.begin(), Targets.end());
	for (size_t i = 0; i < Targets.size(); i++) {
...
/* Wrapper function to debuff all creatures in target vector for _AttackDebuff and _DefenseDebuff amounts and then
create Action object and check the next layer of effects.  */
void Card::CreatureDebuff(vector<Creature*> Targets, Player * Owner)
{
	vector<Card*> tmpCardTargets(Targets.begin(), Targets.end());
...
void Card::CreatureDebuffNoTrigger(vector<Creature*> Targets, Player * Owner)
{
	vector<Card*> tmpCardTargets(Targets.begin(), Targets.end());
	for (size_t i = 0; i < Targets.size(); i++) {
		Targets[i]->BaseAttack = Targets[i]->BaseAttack + _AttackDebuff;
