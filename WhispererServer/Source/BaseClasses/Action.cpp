...
Action::Action(Soul * Attacker, Soul * Target, Player * Owner, _ActionType ActionType) 
	: Attacker(Attacker), Target(Target), Owner(Owner), ActionType(ActionType)
{
}

Action::Action(Soul * Attacker, Player * PlayerTarget, Player * Owner, _ActionType ActionType)
